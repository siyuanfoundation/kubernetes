...
func BuildGenericConfig(
	...
	if lastErr = s.APIEnablement.ApplyTo(genericConfig, controlplane.DefaultAPIResourceConfigSource(genericConfig.CompatibilityVersion, legacyscheme.Scheme)); lastErr != nil {
		return
	}
