...
func TestVersionedFeatureGateKnownFeaturesWithMinCompatVersion(t *testing.T) {
	...
	knownExpected := []string{
		...
		"TestLatestFastBeta=true|false (BETA - default=true) if --min-compatibility-version>=1.29",
	...
	knownExpected = []string{
		...
		"TestBeta=true|false (BETA - default=false)",
		"TestBetaNoVersion=true|false (BETA - default=false)",
		"TestFastBeta=true|false (ALPHA - default=false), or TestFastBeta=true|false (BETA - default=true) if --min-compatibility-version>=1.28",
	}
	assert.ElementsMatch(t, f.KnownFeatures(), knownExpected)
}
...
func TestFeatureGateMinCompatibilityVersion(t *testing.T) {
	...
	knownExpected := []string{
		"AllAlpha=true|false (ALPHA - default=false)",
		"AllBeta=true|false (BETA - default=false)",
		"TestCompatA=true|false (ALPHA - default=false), or TestCompatA=true|false (BETA - default=true) if --min-compatibility-version>=1.30",
	...
	// Trying to enable TestCompatB, TestCompatC should fail.
	require.Error(t, f.Set(string(testCompatGateB)+"=false"))
