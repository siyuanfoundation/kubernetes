...
func (o CustomResourceDefinitionsServerOptions) Config() (*apiserver.Config, error) {
	...
	if err := o.APIEnablement.ApplyTo(&serverConfig.Config, apiserver.DefaultAPIResourceConfigSource(serverConfig.CompatibilityVersion, apiserver.Scheme)); err != nil {
		return nil, err
	}
