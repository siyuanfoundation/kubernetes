...
func TestEnabledVersionWithCompatibilityVersion(t *testing.T) {
	...
	scheme.SetVersionIntroduced(g1v2, "1.29")
	scheme.SetVersionRemoved(g2v1, "1.27")
	scheme.SetVersionIntroduced(g2v2, "1.26")
...
func TestEnabledResourceWithCompatibilityVersion(t *testing.T) {
	...
	scheme := runtime.NewScheme()
	scheme.SetVersionIntroduced(g1v1, "1.29")
	scheme.SetVersionRemoved(g1v2, "1.27")
	scheme.SetVersionIntroduced(g2v1, "1.26")
	scheme.SetVersionRemoved(g2v2, "1.29")
