...
func TestConfigurableStorageFactory(t *testing.T) {
	...
	f := NewDefaultStorageFactory(storagebackend.Config{}, "test/test", ns, NewDefaultResourceEncodingConfig(scheme), NewResourceConfig("", nil), nil)
...
func TestUpdateEtcdOverrides(t *testing.T) {
	...
	for i, test := range testCases {
		...
		storageFactory := NewDefaultStorageFactory(defaultConfig, "", codecs, NewDefaultResourceEncodingConfig(scheme), NewResourceConfig("", nil), nil)
