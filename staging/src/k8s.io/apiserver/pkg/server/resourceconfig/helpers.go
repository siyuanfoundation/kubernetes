...
type GroupVersionRegistry interface {
	...
	// APILifecycleIntroduced returns the map of GroupVersionKind to when the API is first introduced.
	APILifecycleIntroduced() map[schema.GroupVersionKind]semver.Version
}
