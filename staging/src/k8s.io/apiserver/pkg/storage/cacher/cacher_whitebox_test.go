...
func (d *dummyStorage) UpdateWithExponentialBackoff(_ context.Context, _ string, _ runtime.Object, _ bool, _ *storage.Preconditions, _ storage.UpdateFunc, _ runtime.Object, _ wait.Backoff) error {
	return fmt.Errorf("unimplemented")
}
