...
func (o AggregatorOptions) RunAggregator(stopCh <-chan struct{}) error {
	...
	if err := o.APIEnablement.ApplyTo(&serverConfig.Config, apiserver.DefaultAPIResourceConfigSource(serverConfig.CompatibilityVersion, aggregatorscheme.Scheme)); err != nil {
		return err
	}
